...
if [ ! -f "$BUILD_OUTPUT/Bookkeeper.dll" ]; then
    echo "ERROR: Build failed — Bookkeeper.dll not found."
    exit 1
fi
...
cp "$BUILD_OUTPUT/Bookkeeper.dll" "$STAGING_DIR/"
